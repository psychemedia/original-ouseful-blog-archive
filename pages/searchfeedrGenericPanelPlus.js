...
deliSearchURL: function(searchtype) {
 var sfRoot='http://blogs.open.ac.uk/Maths/ajh59/searchfeedrplus.php?';
 ...
 if (location.host=='del.icio.us') {
  ...
  myURL=sfRoot+'f='+myURL+'&q='+query+'&s='+searchtype;
  ...
  if (winkbits[3]=='collections') {
  	...
  	myURL=sfRoot+'f='+escape(myURL)+'&q='+query+'&s='+searchtype;
  	}
