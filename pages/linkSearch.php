<head>
  <title>searchfeedr (linkSearch) - feed limited searches</title>
...
<style type="text/css">
 ...
 #strapline {font-size:90%; color:#006600;}
</style>
...
<div id="page">
  <h1>searchfeedr (linkSearch)  - <span id="strapline">limit your own search</span></h1>

  <p>Search across pages or domains that link to a given URL.</p>
...
<form name="dataForm" action="" onsubmit="deliSearch(); return false;">
  ...
  <table border='0'>
 <tr><td><label for="usrUser">Target URL: </label></td><td><input style="width: 400px;"
...
<tr>
 ...
 id="usrSearchTerms" type="text" value='' /><br /><span class="example">(e.g. searchfeedr)</span></td></tr>
...
<p><input value="linkSearch" class="but" type="submit"> <a href="deliSearchTools.html#searchfeedr">Download searchfeedr tools</a></p>
</form>
...
function performDeliSearchAction(delicious){
 delicious=inlinksfeedjson2deljson(delicious);
 var customtype;
...
function generateNewURL(delicious){
 ...
 if (delicious) {
  ...
  searchString=escape(searchTerms)+'%20-site:'+parseUrlDomain(getFeedURL())+'%20+(';
