...
//		var brandedDiv=document.createElement('div');
		...
		divStyled.setAttribute('style','border:1px solid #e4e4e4; background:#efefff');
...
//            div.insertBefore(link, origTitle);
		div.insertBefore(divStyled,origTitle);
		div.insertBefore(logo, divStyled);
